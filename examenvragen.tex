...
\newpage
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=.68\textwidth]{assets/satelliet}
	...
	\begin{enumerate}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.4\textwidth]{assets/raised_cosine}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=.8\textwidth]{assets/doorlaatspectrum}
